...
public class LRCTrainerActivity extends Activity {
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
		...
		case R.id.mainHelp:
			...
			uri.append("http://sportboot.mobi/trainer/funk/lrc/app/help?view=TrainerActivity");
		...
		case R.id.mainInfo:
			...
			uri2.append("http://sportboot.mobi/trainer/funk/lrc/app/info?view=TrainerActivity");
