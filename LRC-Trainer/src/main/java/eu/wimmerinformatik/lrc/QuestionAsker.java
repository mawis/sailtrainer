...
import eu.wimmerinformatik.lrc.data.Question;
import eu.wimmerinformatik.lrc.data.QuestionSelection;
import eu.wimmerinformatik.lrc.data.Repository;
import eu.wimmerinformatik.lrc.R;
import eu.wimmerinformatik.lrc.StatisticsActivity;
...
public class QuestionAsker extends Activity {
	...
	public boolean onOptionsItemSelected(final MenuItem item) {
		...
		case R.id.help:
		    ...
		    uri.append("http://sportboot.mobi/trainer/funk/lrc/app/help?question=");
