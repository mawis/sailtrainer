...
public class SBFSTrainerActivity extends Activity {
    ...
    public void onResume() {
        ...
        topicList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				final Intent intent = new Intent(SBFSTrainerActivity.this, QuestionAsker.class);
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
		...
		case R.id.mainHelp:
			...
			uri.append("http://sportboot.mobi/trainer/segeln/sbfs/app/help?view=TrainerActivity");
		...
		case R.id.mainInfo:
			...
			uri2.append("http://sportboot.mobi/trainer/segeln/sbfs/app/info?view=TrainerActivity");
