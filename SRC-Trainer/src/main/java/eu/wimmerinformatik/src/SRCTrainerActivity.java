...
//				Toast.makeText((Context) UBITrainerActivity.this, "Clicked: " + id, Toast.LENGTH_LONG).show(); 
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
		...
		case R.id.mainHelp:
			...
			uri.append("http://sportboot.mobi/trainer/funk/src/app/help?view=TrainerActivity");
		...
		case R.id.mainInfo:
			...
			uri2.append("http://sportboot.mobi/trainer/funk/src/app/info?view=TrainerActivity");
