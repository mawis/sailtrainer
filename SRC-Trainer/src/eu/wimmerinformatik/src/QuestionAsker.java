...
import eu.wimmerinformatik.src.data.Question;
import eu.wimmerinformatik.src.data.QuestionSelection;
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case R.id.help:
				...
				uri.append("http://sportboot.mobi/trainer/funk/src/app/help?question=");
